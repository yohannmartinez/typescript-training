describe('Template literals', () => {
  ...
  it('should support string interpolation', () => {
    ...
    const friendsStr = person => {
      return person.name + " has " + person.friends.length + " friends: " + person.friends;
    }
  ...
  it('can be curried', () => {
    ...
    // function addCity(ville1,ville2,ville3) {
    //   let journey = tagIt`${ville1}, then ${ville2} and finally ${ville3}!`
    // }
    const journey = (a1) => (a2) => (a3) => a1 + a2 + a3;
    return journey;
